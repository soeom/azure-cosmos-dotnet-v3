...
namespace Microsoft.Azure.Documents
{
    ...
    /// </summary>
    internal sealed class VectorSessionTokenOld : ISessionToken
    {
        ...
        private VectorSessionTokenOld(long version, long globalLsn, IReadOnlyDictionary<uint, long> localLsnByRegion, string sessionToken = null)
        {
            ...
            if (this.sessionToken == null)
            {
                string regionProgress = string.Join(
                    VectorSessionTokenOld.SegmentSeparator.ToString(),
                    localLsnByRegion.Select(kvp => string.Format(CultureInfo.InvariantCulture, "{0}{1}{2}", kvp.Key, VectorSessionTokenOld.RegionProgressSeparator, kvp.Value)));
                ...
                if (string.IsNullOrEmpty(regionProgress))
                {
                    this.sessionToken = string.Format(
                        ...
                        "{0}{1}{2}",
                        this.version,
                        VectorSessionTokenOld.SegmentSeparator,
                        this.globalLsn);
                }
                else
                {
        ...
        public VectorSessionTokenOld(VectorSessionTokenOld other, long globalLSN)
        ...
        public static bool TryCreate(string sessionToken, out ISessionToken parsedSessionToken)
        {
            ...
            if (VectorSessionTokenOld.TryParseSessionToken(
                sessionToken,
                out version,
                out globalLsn,
                out localLsnByRegion))
            {
                parsedSessionToken = new VectorSessionTokenOld(version, globalLsn, localLsnByRegion, sessionToken);
                return true;
            }
            else
            {
        ...
        {
            VectorSessionTokenOld other = obj as VectorSessionTokenOld;
        ...
        {
            VectorSessionTokenOld other = otherSessionToken as VectorSessionTokenOld;
        ...
        public ISessionToken Merge(ISessionToken obj)
        {
            ...
            VectorSessionTokenOld sessionTokenWithHigherVersion;
            VectorSessionTokenOld sessionTokenWithLowerVersion;
            ...
            return new VectorSessionTokenOld(
            ...
            out IReadOnlyDictionary<uint, long> localLsnByRegion)
        {
            ...
            string[] segments = sessionToken.Split(VectorSessionTokenOld.SegmentSeparator);
            ...
            {
                string[] regionIdWithLsn = regionSegment.Split(VectorSessionTokenOld.RegionProgressSeparator);
