    ...
    internal sealed class SessionTokenMismatchRetryPolicy : IRetryPolicy
    {
            ...
            SubStatusCodes? subStatusCode)
        {
                ...
                && subStatusCode.HasValue && subStatusCode.Value == SubStatusCodes.ReadSessionNotAvailable)
            {
                ...
                {
                    this.currentBackoffInMilliSeconds = this.currentBackoffInMilliSeconds.HasValue ?
                        this.currentBackoffInMilliSeconds.Value : SessionTokenMismatchRetryPolicy.sessionRetryInitialBackoffConfig.Value;
